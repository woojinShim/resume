  ...
  list: [
    ...
    },
    {
      ...
      descriptions: [
        ...
        { content: 'NFT를 listing, buying, cancel 할 수 있는 Marketplace 컨트랙 배포' },
        { content: 'The Graph를 이용하여 buyer, seller, nftAddress, tokenId, price 정보를 subGraph Indexing' },
      ],
    },
  ],
};
