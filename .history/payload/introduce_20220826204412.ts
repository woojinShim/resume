...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    '웹/댑 서비스 개발과 컨트랙 작성, 테스트, 배포, 함수콜을 해본 경험이 있습니다. Solidity, Hardhat, ethers.js, ipfs, Git, React 등을 사용하여 NFT 프로덕션 서비스를 개발하며 대중적이고 재미있고 유의미한 서비스를 제공하기 위해 항상 고민하고 있습니다.',
